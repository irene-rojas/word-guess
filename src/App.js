    ...
    return (
        <div className="App">
            ...
            <div className="gameDiv">
                ...
                <p>Powered by Merriam-Webster <a href="https://dictionaryapi.com/" target="_blank" rel="noopener noreferrer"><img className="mwLogo" src={mwLogo} alt="Merriam-Webster Logo" /></a></p>
            </div>
        </div>
    );
}
